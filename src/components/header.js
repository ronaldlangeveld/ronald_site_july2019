              ...
              <div className="columns is-centered">
                ...
                <br />
                  <div className="content">
                    ...
                    <p>More recently I’m developing web applications with <strong>NodeJS</strong> and <strong>ReactJS</strong> while learning <strong>React Native</strong> to build iOS and.</p>
